...
from .views import dashboard, signUp, SignUp, updateUserAndProfileModelView,UpdateClassView
...
urlpatterns = [
    ...
    path('dashboard/edit/', UpdateClassView.as_view(), name='edit_user_informations'),
]